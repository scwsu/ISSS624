...
Next, we prepare a reusable function by utilizing [`st_contiguity()`](https://sfdep.josiahparry.com/reference/st_contiguity.html) to derive a contiguity neighbor list by using Queen's method.
