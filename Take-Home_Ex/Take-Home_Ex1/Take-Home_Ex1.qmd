...
draw_honeycomb_map(honeycomb_count_6_9)
...
```{r}
draw_honeycomb_map(honeycomb_count_17_20)
```
...
```{r}
draw_honeycomb_map(honeycomb_count_11_14)
```
...
```{r}
draw_honeycomb_map(honeycomb_count_16_19)
```
:::
