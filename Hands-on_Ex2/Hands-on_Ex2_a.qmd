...
The following code chunk installs and loads **sf**, **readr**, **dplyr** and **spdep** packages into R environment.

::: callout-note
**sf** package is used to import geospatial data into my working environment.

**readr** package is used to load the data from a csv file.

**dplyr** package is used to execute relation joings between datasets.

**spdep** package is used to calculate spatial weights and compute spatially lagged variables.
:::

```{r}
pacman::p_load(sf, readr, dplyr, spdep)
```
